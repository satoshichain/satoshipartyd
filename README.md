...
However, a shellpartyd configuration file looks like this:
...
* Broadcast
	...
	Note: for some users shellpartyd has trouble parsing spaces in the `--text` argument. One workaround is to
